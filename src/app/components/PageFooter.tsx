    ...
    <Footer container className="bg-stone-950 footer rounded-none">
      <div className="w-full text-start">
        ...
        <div className="w-full justify-between sm:flex sm:items-center sm:justify-between">
          ...
          <Footer.LinkGroup className="flex flex-col justify-center items-center gap-2">
            <div className="flex flex-col items-center justify-center">
              <Footer.Link className="text-3xl text-center footer-links m-0 font-bold navbar-link-hover no-underline" href="https://ntslogistics.com/team/adam-noah/">
                <span className="text-secondary-y flex items-center justify-center gap-2">
            ...
            <div className="flex gap-2 mt-2">
              <Footer.Link className="text-lg footer-links font-bold navbar-link-hover border-gray-200 md:mb-0 md:mr-4 md:border-r md:pr-4" href="https://www.linkedin.com/in/adam-m-noah/">
                <FaLinkedin className="h-16 w-16 text-secondary-y" />
              </Footer.Link>
              <Footer.Link className="text-lg footer-links font-bold navbar-link-hover border-gray-200 md:mb-0 md:pr-4" href="https://github.com/adamn1225">
        ...
        <div className="flex md:flex-row flex-col md:justify-center md:mb-2 justify-stretch w-full items-center">
          {/* <Button href="/login" className="md:bg-stone-800 footer-button md:w-1/6 w-full text-gray-300 hover:bg-stone-700 hover:text-mute-200">
